export const pt = {
  ...
  home: {
    ...
    emptyWalletSubtitle: 'Toque no botão abaixo para criar sua primeira carteira',
    deleteWalletTitle: 'Excluir carteira',
    deleteWalletDescription: 'Tem certeza? Todas as transações desta carteira também serão excluídas.',
  ...
  profile: {
    ...
    clearDataDialogDescription:
      'Todas as suas carteiras, transações e categorias serão removidas permanentemente. Essa ação não tem volta.',
