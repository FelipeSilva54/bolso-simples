export const pt = {
  ...
  home: {
    ...
    emptyWalletSubtitle: 'Clique no botão abaixo para criar sua primeira carteira',
  ...
  wallet: {
    ...
    emptySubtitle: 'Clique no botão de + para adicionar uma receita ou despesa.',
  ...
  transaction: {
    ...
    notesPlaceholder: 'Ex: Carteira do Thiago',
