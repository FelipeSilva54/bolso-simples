      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.section, styles.legalSection]}>
          <TouchableOpacity
            ...
            onPress={() => Linking.openURL('https://felipesilva54.github.io/bolso-simples/termos/')}
            activeOpacity={0.7}
          ...
          <TouchableOpacity
            style={styles.linkRow}
            onPress={() => Linking.openURL('https://felipesilva54.github.io/bolso-simples/privacidade/')}
            activeOpacity={0.7}
            accessibilityRole="link"
